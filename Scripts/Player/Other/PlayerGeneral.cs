...
namespace AdaptiveWizard.Assets.Scripts.Player.Other
{
    public class PlayerGeneral : AbstractPlayer
    {
        ...
        public void UpdateMaxHealth() {
            ...
            foreach (PlayerHealthModifier item in InventoryManager.passiveItemsManager.playerHealthModifiers) {
        ...
        public void UpdateMaxMana() {
            ...
            foreach (MaxManaModifier item in InventoryManager.passiveItemsManager.maxManaModifiers) {
